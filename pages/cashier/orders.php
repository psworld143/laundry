...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <?php if (empty($orders)): ?>
        <div class="text-center py-12">
            ...
            <p class="text-gray-500">Click "New Order" to create the first one.</p>
        </div>
    <?php else: ?>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="text-left py-3 px-4 font-semibold text-gray-700">Laundry</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-sm">
                            <?php $ls = $order['laundry_status']; ?>
                           <span class="px-2 py-1 rounded-full text-xs font-bold <?php echo $ls==='ready'?'bg-green-100 text-green-800':'bg-blue-100 text-blue-800'; ?>">
                                <?php echo ucfirst(str_replace('_',' ',$ls)); ?>
                           </span>
                        </td>
                        <td class="py-3 px-4 text-sm text-gray-600"><?php echo date('M d, Y h:i A', strtotime($order['created_at'])); ?></td>
                        <td class="py-3 px-4">
                            <div class="flex space-x-2">
                                <a href="../receipt-viewer.php?id=<?php echo $order['payment_id']; ?>" class="text-blue-600 hover:text-blue-800" title="Copy Receipt"><i class="fas fa-receipt"></i></a>
